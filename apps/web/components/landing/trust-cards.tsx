      ...
      {cards.map((card, index) => (
        <Card key={index} className="border-light-gray bg-white">
          <CardContent className="p-4 flex items-start gap-3">
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-sage-green/10 border border-sage-green/20 flex items-center justify-center">
              <span className="text-sage-green">{card.icon}</span>
            </div>
            <div>
